...
Here is the source for utility module =util.py=
#+BEGIN_SRC python
def get_path(filename):
    """Return file's path or empty string if no path."""
    import os
...
#+END_SRC
**** TODO Continuing Execution
[[https://realpython.com/python-debugging-pdb/#continuing-execution]]
**** TODO Displaying Expressions
[[https://realpython.com/python-debugging-pdb/#displaying-expressions]]
**** TODO Python caller id
[[https://realpython.com/python-debugging-pdb/#python-caller-id]]
