import random
import sys
from typing import Dict, List, Tuple, Sequence, Any, TypeVar, Optional
...
class Deck:
    ...
    def create(cls, shuffle: bool = False) -> "Deck":
        ...
        cards = [(s, r) for r in Card.RANKS for s in Card.SUITS]
        if shuffle:
    ...
    def deal(self, num_hands: int) -> Tuple[Deck]:
        ...
        cls = self.__class__
        return tuple(
            cls(self.cards[i::num_hands]) for i in range(num_hands)
        )
